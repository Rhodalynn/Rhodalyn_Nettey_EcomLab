!(function(t, e) {
    ...
    function o(t, e) {
        return (
            ...
            (function(t, e) {
                ...
                try {
                    for (
                        var a, o = t[Symbol.iterator](); !(r = (a = o.next()).done) &&
    ...
    function m(s, a) {
        return function(t) {
            for (
                var e = arguments.length, i = new Array(1 < e ? e - 1 : 0), r = 1; r < e; r++
            )
                i[r - 1] = arguments[r];
            return (
    ...
    a.prototype = {
        ...
        addCatalog: function(t, e, i) {
            return (
                "object" === n(e) && (this.catalog[t] = e), !0 === i ? this.setLocale(t) : this
            );
        },
    ...
    (v.Form = {
        ...
        focus: function() {
            if (!(this._focusedField = null) === this.validationResult ||
        ...
        rejected: !(b.prototype = {
            validate: function(t, e) {
                ...
                return (i = this.validator).validate.apply(
                    i, [t].concat(u(this.requirementList), [e])
                );
            },
    ...
    w.prototype = {
        ...
        needsValidation: function(t) {
            return (
                void 0 === t && (t = this.getValue()), !(!t.length &&
                    !this._isRequired() &&
        ...
        whenValid: function(t) {
            ...
            if ((e._refreshed || this.refresh(), !a || this._isInGroup(a))) {
                if (((this.validationResult = !0), !this.hasConstraints()))
                    return h.when();
                if (
                    (null == s && (s = this.getValue()), !this.needsValidation(s) && !0 !== n)
                )
                    return h.when();
